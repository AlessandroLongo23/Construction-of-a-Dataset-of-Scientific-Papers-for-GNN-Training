...
%%%%%
%ARXIV v2 Comment
%additional results using Planck PR4 Hillipop/Lollipop and DES SN5YR
%%%%%
...
% ,
% which has displayed a resolution to the anomalous amplitude of the lensing power spectrum in the \planck~ data, see \cite{Planck:2018vyg}) and the DES-SN5YR supernovae dataset (\DES \cite{}), showing consistency with \cref{fig:SHOES} and \cref{tab:plusshoes}; in the case of \planck\desi\pantheon, we even see further evidence for $\DNeff$ and a reduced $H_0$ tension to $\sim 1.9 \sigma$.

% \textcolor{red}{In addition, we provide limited results with the following two datasets to present a comparison with the datasets above:}

% \begin{itemize}
%     \item \textcolor{red}{\DES: the supernovae dataset from DES \cite{}}

% \item \textcolor{red}{\planckhilli: Planck 2020 (PR4) results as implemented in the Hillipop/Lollipop likelihoods \cite{}}
% \end{itemize}

% \textcolor{red}{comment here on limited results with new likelihoods}
